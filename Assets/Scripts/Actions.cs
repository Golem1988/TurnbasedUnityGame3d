...
public static class Actions
{
    ...
    public static Action<UnitStateMachine> OnKill; //when someone kills someone
    ...
    public static Action OnDungeonChestTrigger;
    public static Action OnDungeonHealTrigger;
